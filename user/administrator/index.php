...
$row_kembali = mysqli_num_rows($query_kembali);
...
<body>
    ...
    <div class="main-content">
            ...
            <div class="card1">
                        <h3 class="card-text"><i class="bi bi-person-circle"></i> Petugas</h3>
                        <p class="card-title"><?= $row_petugas; ?></p>
                        <a href="dataUser.php#petugas" class="button">Lihat</a>
            </div>
            <div class="card1">
                        <h3 class="card-text"><i class="bi bi-person-circle"></i> Peminjam</h3>
                        <p class="card-title"><?= $row_peminjam; ?></p>
                        <a href="dataUser.php#peminjam" class="button">Lihat</a>
            </div>
            <div class="card2">
                        <h3 class="card-text"><i class="fa fa-book"></i> Buku</h3>
                        <p class="card-title"><?= $row_buku; ?></p>
            ...
            <div class="card4">
                        <h3 class="card-text"><i class="fa fa-sign-in"></i> Pengembalian</h3>
                        <p class="card-title"><?= $row_kembali; ?></p>
                        <a href="pengembalian.php" class="button">Lihat</a>
            </div>
            <div class="card5">
                        <h3 class="card-text"><i class="fa fa-sign-out"></i> Peminjaman</h3>
                        <p class="card-title"><?= $row_pinjam; ?></p>
                        <a href="peminjaman.php" class="button">Lihat</a>
            </div>
    </div>
